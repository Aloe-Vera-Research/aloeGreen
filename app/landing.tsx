...
const styles = StyleSheet.create({
  ...
  logo: { width: 160, height: 160, marginBottom: 20, borderRadius: 20 },
  title: { fontSize: 32, fontWeight: "bold", color: "#1B5E20" },
  subtitle: { fontSize: 16, color: "#2E7D32", marginBottom: 40, textAlign: "center" },
  button: { backgroundColor: "#2E7D32", paddingVertical: 16, paddingHorizontal: 50, borderRadius: 14 },
